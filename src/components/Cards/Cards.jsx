    ...
    return (
        <div className={styles.container}>
            <Grid container spacing={3} justify="center">
                ...
                <Grid xs={12} spacing={3} className={cx(styles.card, styles.infected)} item component={Card}>
                    <CardContent>
                ...
                <Grid xs={12} className={cx(styles.card, styles.recovered)} item component={Card}>
                    <CardContent>
                ...
                <Grid xs={12} className={cx(styles.card, styles.deaths)} item component={Card}>
                    <CardContent>
